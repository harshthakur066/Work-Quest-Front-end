...
return(<div id="wholepage" className="pageWrapper">
  ...
  <div className="navbar">
      ...
      <div className={`nav_items_wrapper ${isActive?'nav_active':''}`} id="myNavbar">
          ...
          <div className="nav_link_container">
            ...
            <ul className="nav_link_items">
          		<li><a className="nav-links" onClick={this.scrollTofun.bind(this,'about')}>WHAT IS WORK COIN?</a></li>
      				<li><a className="nav-links" onClick={this.scrollTofun.bind(this,'sale')}>TOKEN SALE</a></li>
      				<li><a className="nav-links" onClick={this.scrollTofun.bind(this,'road')}>ROAD MAP</a></li>
      				<li><a className="nav-links" onClick={this.scrollTofun.bind(this,'mvp')}>MVP</a></li>
      				<li><a className="nav-links" onClick={this.scrollTofun.bind(this,'team')}>TEAM</a></li>
      				<li><a className="nav-links" onClick={this.scrollTofun.bind(this,'contact')}>CONTACT</a></li>
      				<li><a className="nav-links" onClick={this.scrollTofun.bind(this,'faq')}>FAQ</a></li>
            </ul>
            <div className="nav_link_items">
              <a id="signup" className="account nav-links" onClick={this.handleForm.bind(this,'signup')}>SIGN UP</a>
  ...
  <div  id="login-form" style={{display: this.state.login?"block":"none"}}  className="form_bg_container">
      	...
      	<div className="login_form_container">
              ...
              <div className="login_form_btns">
                ...
                <div className="forgot_or_create">
                  ...
                  <p className="mediumletter3">DON'T HAVE AN ACCOUNT YET?</p>
                </div>
                <button id="signup2" className="signupbtn" onClick={this.handleForm.bind(this,'signup')}>CREATE ACCOUNT</button>
              </div>
            </div>
      	</div>
      </form>
  ...
  <div id="forgot-pass" style={{display: this.state.forgot?'block':'none'}} className="forgot_pass_container">
   <div className="form_forgot_pass">
    <span id="xx" className="close" onClick={this.closeForm.bind(this,'forgot')} title="Close Modal">&times;</span>
    <div className="forgot_item">
  	  <p className="forgot-heading">FORGOT YOUR PASSWORD?</p>
  	  <p className="smallletters"> Don't worry, just enter your registered email and we'll send you a link to your registered email.</p>
  ...
  <div id="forgot-pass-notif" className="forgot_pass_container">
    <div className="forgot-notif-item">
  	    <span id="xx" className="close" title="Close Modal">&times;</span>
  	    <p className="forgot-heading">CHECK YOUR EMAIL </p>
  	    <p className="pass-email-conf">We've sent an email to your mail. Click the link in the email to reset the password.</p>
        <p className="pass-email-conf">If you don't see the mail, check other plpaces it might be in spam or other folders.</p>
    </div>
  </div>
  <div id="signup-form" style={{display: this.state.signup?'block':'none'}} className="form_bg_container">
    <div className="form_parent">
      ...
      <form className="form-content">
        ...
        <div className="register_container">
          <button className="registerbtn" onClick={this.handleSignup}>REGISTRATION</button>
        </div>
      </form>
    </div>
  </div>
  ...
  ZERO COST TO LIST NEW EMPLOYEES.</p>
	...
	<p className="heading1">TOKEN SALE INFO</p>
		<p className="smallletters9">THE WORK COIN WILL BE ISSUED AS AN INDEPENDENT BLOCKCHAIN WORK QUEST AND WE WILL ISSUE 2 BILLION TOKENS</p>
	<div className="countdown">
	  <p className="mediumletter">ICO WILL BE STARTED IN</p>
    <ul className="countdown-item">
  	  <li><div id="exbox1" className="countdown-boxes">{this.state.timer.days}</div><p>DAYS</p></li>
   	  <li><div id="exbox2" className="countdown-boxes">{this.state.timer.hours}</div><p>HOURS</p></li>
   	  <li><div id="exbox3" className="countdown-boxes">{this.state.timer.minutes}</div><p>MINUTES</p></li>
   	  <li><div id="exbox4" className="countdown-boxes">{this.state.timer.seconds}</div><p>SECONDS</p></li>
    </ul>
      <a className="timer-button" href="#">JOIN AND BUY TOKEN NOW</a>
  </div>
  ...
  <div className="section section6" id="road" ref={this.road}>
    ...
    <p className="smallletters9">WITH HELP FROM OUR TEAMS, CONTRIBUTORS AND INVESTORS THESE ARE THE MILESTONES WE ARE LOOKING FORWARD TO ACHEIVE</p>
    ...
    <div className="section section6-item3 section6-items">
      ...
      <div className="section6-item4-content">
          ...
          <a className="timer-button" href="Workquest/index.html">ENTER PLATFORM</a>
      </div>
  	</div>
  </div>
	<div className="section section7" id="team" ref={this.team}>
	<p className="heading1 section-heading">OUR TEAM</p>
	<p className="smallletters9 section-description">OUR TEAM IS PASSIONATE AND COMMITED TO DELIVER RESULTS. DIVERSITY IS KEY TO US AND DRIVING INNOVATION DESIRED ON WORK QUEST</p>
  <div className = "carousel2">
	...
	<div className="section section8" id="contact" ref={this.contact}>
  	...
  	<p className="smallletters9 section8-context">ANY QUESTION? REACH OUT TO US AND WE’LL GET BACK TO YOU SHORTLY.</p>
    <form className="contact_form">
       <p className="contact_input">
          <label  className="smallletters9" htmlFor="contact_form_name">YOUR NAME</label>
          <input type="text" name="contact_form_name" />
       </p>
       <p className="contact_input">
         <label className="smallletters9" htmlFor="contact_form_email">YOUR EMAIL</label>
         <input type="text" name="contact_form_email" />
       </p>
       <p className="contact_input">
         <label className="smallletters9" htmlFor="contact_form_msg">YOUR MESSAGE</label>
  ...
  <div className="section section9" id="faq" ref={this.faq}>
    <p className="heading1 section9-heading">FREQUENTLY ASKED QUESTIONS</p>
    <p className="smallletters9 section9-context">BELOW WE’VE PROVIDED INFORMATION ABOUT WORKQUEST AND WORK COIN(WRC), AND FEW OTHERS, IF YOU HAVE ANY QUESTIONS, PLEASE GET IN TOUCH USING THE CONTACT FORM BELOW</p>
    <div className="faq-wrapper">
      ...
      <div className="faq-content">
        <div  className={this.state.faq_active == 'general'? 'faq-items' : 'faq-items display_none_className'}  >
          <p className="mediumletter2 faq-heading-item">GENERAL</p>
          <div className="faq-item">
            <p className="blueletters2">WHAT IS THE DIFFERENCE BETWEEN A WORK QUEST AND A WORK COIN</p>
            <p className="smallletters9">WORK QUEST IS A PLATFORM CONNECTING EMPLOYERS AND EMPLOYEES USING BLOCKCHAIN TECHNOLOGY. WORK COIN(WRC) IS THE TOKEN USED IN THE ECO-SYSTEM TO FACILITATE PAYMENTS AND OTHER TRANSACTIONS</p>
          </div>
          <div className="faq-item">
            <p className="blueletters2">WHAT CRYPTOCURRENCIES CAN I USE TO PURCHASE WRC?</p>
            <p className="smallletters9">ONE CAN USE ETH, BTC, LTC OR EVEN FIAT MONEY</p>
          </div>
          <div className="faq-item">
            <p className="blueletters2">HOW CAN I PARTICIPATE IN THE ICO TOKEN SALE?</p>
            <p className="smallletters9">IT IS EASY, REGISTER ON OUR WEBSITE, THE ACQUIRE THE ACCEPTED CRYPTOCURRENCIES NAMELY, BTC ETH AND LTH, SEND THE RESPECTIVE CRYPTOCURRENCY YOU PURCHASED AND HAVE IN YOUR WALLET OUR CAMPAIGN ADDRESS AND IN RETURN YOU RECEIVE THE WRC TOKENS AND THEN STORE THEM IN YOUR PREFERRED WALLET
            </p>
          </div>
          <div className="faq-item">
        ...
        <div className={this.state.faq_active == 'ico'? 'faq-items' : 'faq-items display_none_className'}>
          ...
          <div className="faq-item">
            ...
            <p className="smallletters9">SUCCESFUL ICO WILL ENABE US DEVELOP AND ACQUIRE MORE BLOCKCHAIN AND CRYPTOCURRENCY TALENT TO CREATE A HIGHLY UNIQUE AND BENEFICIAL PLATFORM TO HELP OUR STAKEHOLDERS. ALL OUR PROCEEDS GO TO PRODUCT DEVELOPMENT RELATED ACTIVITIES AND LAUNCH AS WELL AS USER ACQUISATION
            </p>
          </div>
          <div className="faq-item">
            <p className="blueletters2">WHY SHOULD YOU INVEST IN OUR ICO?</p>
            <p className="smallletters9">WE ARE COMMMITED TO CREATE THE MOST ADVANCED AND TRUSTWORTHY PLATFORM THAT TRANSFORMS RELATIONS BETWEEN EMPLOTYERS AND EMPLOYEES IN THE INDUSTRY AND AT A GLOBAL SCALE. WE TARGET 3.5 MILLION USERS AND 10,000 CORPORATE USERS BY 2023</p>
          </div>
          <div className="faq-item">
            <p className="blueletters2">WHAT IS THE GOAL OF THE ICO CAMPAIGN?</p>
            <p className="smallletters9">THE MAXIMUM TARGET FOR THE CAMPAIGN IS $1O MILLION</p>
          </div>
          <div className="faq-item">
            <p className="blueletters2">HOW CAN YOU BE SURE WORK WILL COMMENCE AFTER TOKEN SALE?</p>
            <p className="smallletters9">WE ARE A TEAM OF PEOPLE DRIVEN BY RESULTS AND THIS IS EVIDENT FROM OUR PAST PROJECTS WIHTING THE ICO AND OUTSIDE THE ICO SPACE. THE TEAM EITHE RCOLLABORATIVELY OR INDIVIDUALLY HAVE BEEN INVOLVED IN INTERNATIONAL PROJECTS WHICH HAVE BEEN CONCLUDED TO FRUITION. WE ARE USING ICO FINACNING METHOD BECAUSE OF ITS AFFORDABILITY AND ABILITY TO INVOLVE OTHER PEOPLE WORLDWIDE IN OUR PROJECT</p>
          </div>
        </div>
      </div>
    </div>
